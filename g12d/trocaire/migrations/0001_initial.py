...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('trocaire_organizacion', (
            ...
            ('logo', self.gf('g12d.thumbs.ImageWithThumbsField')(max_length=100, null=True, blank=True)),
            ('last_register', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 5, 21, 0, 0))),
        ))
